export AZURE_CACHE_NAME=acme-fitness-cache-stne                  # Unique name for Azure Cache for Redis Instance
export POSTGRES_SERVER=acme-fitness-db-stne                  # Unique name for Azure Database for PostgreSQL Flexible Server
