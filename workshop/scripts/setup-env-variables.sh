...
export SPRING_APPS_SERVICE=acme-fitness-murthy-1   # name of the service that will be created in the next steps
export LOG_ANALYTICS_WORKSPACE=acme-fitness-la-stne   # existing workspace or one that will be created in next steps
